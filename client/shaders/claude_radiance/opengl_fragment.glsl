...
// radiance arriving at the cell from direction rd, SURFACES ONLY:
// sky escape returns 0 by design (claude_accum's SKY_BOUNCE already
// pays out one sky bounce; adding it here would count it twice).
