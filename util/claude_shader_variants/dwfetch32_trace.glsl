...
// DEAD WEIGHT K=32 (fetch): inert, unreachable, un-foldable. Timing arm only.
// =====================================================================
		...
		out vec3 le, out float tHit, out vec3 cellOut)
{
	...
	for (int i = 0; i < WALK_STEPS; i++) {
		...
		// DEAD WEIGHT, K = 32 (texture reads only, minimal live registers). Never executed: game.cpp
