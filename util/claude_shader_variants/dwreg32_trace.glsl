...
// DEAD WEIGHT K=32 (reg): inert, unreachable, un-foldable. Timing arm only.
// =====================================================================
		...
		out vec3 le, out float tHit, out vec3 cellOut)
{
	...
	for (int i = 0; i < WALK_STEPS; i++) {
		...
		// DEAD WEIGHT, K = 32 (registers only, no texture reads). Never executed: game.cpp
		...
		if (claudeDescend > 5.0) {
			vec4 w0 = g_dw * 1.0009765625 + vec4(0.5);
			vec4 w1 = w0 * 1.0009765625 + vec4(1.5);
			vec4 w2 = w1 * 1.0009765625 + vec4(2.5);
			vec4 w3 = w2 * 1.0009765625 + vec4(3.5);
			vec4 w4 = w3 * 1.0009765625 + vec4(4.5);
			vec4 w5 = w4 * 1.0009765625 + vec4(5.5);
			vec4 w6 = w5 * 1.0009765625 + vec4(6.5);
			vec4 w7 = w6 * 1.0009765625 + vec4(7.5);
			vec4 w8 = w7 * 1.0009765625 + vec4(8.5);
			vec4 w9 = w8 * 1.0009765625 + vec4(9.5);
			vec4 w10 = w9 * 1.0009765625 + vec4(10.5);
			vec4 w11 = w10 * 1.0009765625 + vec4(11.5);
			vec4 w12 = w11 * 1.0009765625 + vec4(12.5);
			vec4 w13 = w12 * 1.0009765625 + vec4(13.5);
			vec4 w14 = w13 * 1.0009765625 + vec4(14.5);
			vec4 w15 = w14 * 1.0009765625 + vec4(15.5);
			vec4 w16 = w15 * 1.0009765625 + vec4(16.5);
			vec4 w17 = w16 * 1.0009765625 + vec4(17.5);
			vec4 w18 = w17 * 1.0009765625 + vec4(18.5);
			vec4 w19 = w18 * 1.0009765625 + vec4(19.5);
			vec4 w20 = w19 * 1.0009765625 + vec4(20.5);
			vec4 w21 = w20 * 1.0009765625 + vec4(21.5);
			vec4 w22 = w21 * 1.0009765625 + vec4(22.5);
			vec4 w23 = w22 * 1.0009765625 + vec4(23.5);
			vec4 w24 = w23 * 1.0009765625 + vec4(24.5);
			vec4 w25 = w24 * 1.0009765625 + vec4(25.5);
			vec4 w26 = w25 * 1.0009765625 + vec4(26.5);
			vec4 w27 = w26 * 1.0009765625 + vec4(27.5);
			vec4 w28 = w27 * 1.0009765625 + vec4(28.5);
			vec4 w29 = w28 * 1.0009765625 + vec4(29.5);
			vec4 w30 = w29 * 1.0009765625 + vec4(30.5);
			vec4 w31 = w30 * 1.0009765625 + vec4(31.5);
			g_dw += w0 + w1 + w2 + w3
					+ w4 + w5 + w6 + w7
					+ w8 + w9 + w10 + w11
					+ w12 + w13 + w14 + w15
