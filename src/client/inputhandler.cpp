...
void MyEventReceiver::reloadKeybindings()
{
	...
	keybindings[KeyType::TOGGLE_CLAUDE_BOUNCE] = getKeySetting("keymap_toggle_claude_bounce");
	keybindings[KeyType::CLAUDE_VIEW_CYCLE] = getKeySetting("keymap_claude_view_cycle");
